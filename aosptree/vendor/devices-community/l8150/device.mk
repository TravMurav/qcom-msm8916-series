...
PRODUCT_COPY_FILES += \
    glodroid/linux-firmware/qcom/a300_pfp.fw:$(TARGET_COPY_OUT_VENDOR)/firmware/a300_pfp.fw \
    glodroid/linux-firmware/qcom/a300_pm4.fw:$(TARGET_COPY_OUT_VENDOR)/firmware/a300_pm4.fw \
...
PRODUCT_PACKAGES += l8150_firmware

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/etc/init.rmtfs.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/init.rmtfs.rc \
    $(LOCAL_PATH)/etc/permissions.l8150.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/permissions.l8150.rc \
    $(LOCAL_PATH)/etc/sensors.l8150.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/sensors.l8150.rc \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/etc/audio.l8150.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio.l8150.xml \

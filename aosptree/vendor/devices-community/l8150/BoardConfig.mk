...
BOARD_USERDATAIMAGE_PARTITION_SIZE := $(shell echo $$(( 12679 * 1024 * 1024 )))

# System image 1536 MiB
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_PARTITION_SIZE   := $(shell echo $$(( 1536 * 1024 * 1024 )))

# Vendor image 150 MiB
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_PARTITION_SIZE   := $(shell echo $$(( 150 * 1024 * 1024 )))
